    ...
    user_pop_data: {
        ...
        gt_handler: function (captchaObj) {
            ...
            captchaObj.onReady(function(){
                ...
                user_pop_data.validate_flag = captchaObj.getValidate();
            }).onError(function(){
    ...
    init: (user_pop_data) => {
        ...
        document.querySelector('.js-get-code').addEventListener('click', (e) => {
            ...
            if(!/^1\d{10}$/gi.test(_phone)){
                ...
                ajaxPost(
                    user_pop_data.code_url,
                    {
                        'cellphone': _phone,
                        'action': 'login',
                        'geetest_challenge': user_pop_data.validate_flag.geetest_challenge,
                        'geetest_validate': user_pop_data.validate_flag.geetest_validate,
                        'geetest_seccode': user_pop_data.validate_flag.geetest_seccode
                    },
                    user_pop_data.success,
                    user_pop_data.before,
                    user_pop_data.error,
                    {},
                    user_pop_data.alert
                );
        ...
        ajaxGet(
            user_pop_data.gt_url + "?t=" + (new Date()).getTime(),
            user_pop_data.gt_validate_succ,
            user_pop_data.before,
            user_pop_data.error,
            'json'
        );
